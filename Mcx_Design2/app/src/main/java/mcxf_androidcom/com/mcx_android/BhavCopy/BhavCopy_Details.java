...
public class BhavCopy_Details extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    // Log tag
    private static final String TAG = BhavCopy_Details.class.getSimpleName();

    // BhavCopy json url
    private static final String url = "http://192.168.0.112:8888/bhavcopynew.php";
    private ProgressDialog pDialog;
    private List<BhavCopy> BhavCopylist = new ArrayList<BhavCopy>();
    private ListView listView;
    private BhavCopyAdapter adapter;
    //String Prodcut = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bhav_copy_details);

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        TextView textView = (TextView) toolbar.findViewById(R.id.BhavCopy);
        if(toolbar!=null) {
            setSupportActionBar(toolbar);
            toolbar.setNavigationIcon(R.drawable.ic_ab_drawer);
        }

//        ScrollView scrollView = (ScrollView) findViewById(R.id.scrollablecontents);
//        getLayoutInflater().inflate(R.layout.list_bhavcopy,scrollView);

        listView = (ListView) findViewById(R.id.list);
//        ViewGroup headerView = (ViewGroup)getLayoutInflater().inflate(R.layout.header_bhavcopy, listView,false);
//        listView.addHeaderView(headerView);
        adapter = new BhavCopyAdapter(this, BhavCopylist);
        ...
        JsonArrayRequest BhavCopyReq = new JsonArrayRequest(url,
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        for (int i = 0; i < response.length(); i++) {
                            try {
                                ...
                                bhavCopy.setDate(obj.getString("Date"));
                                bhavCopy.setCommodity(obj.getString("Product"));
                                bhavCopy.setExpiry(obj.getString("Expiry"));
                                bhavCopy.setClose(String.format("%.2f", obj.getDouble("Close")));
                                bhavCopy.setPCP(String.format("%.2f", obj.getDouble("PCP")));
                                bhavCopy.setATP(String.format("%.2f", obj.getDouble("ATP")));
                                bhavCopy.setVolume(String.format("%.2f", obj.getDouble("Total_Qty_Traded")));
                                bhavCopy.setValue(String.format("%.2f", obj.getDouble("Total_Value_Traded")));
                                bhavCopy.setOI(String.format("%.2f", obj.getDouble("OI")));

                                // adding BhavCopy to bhavcopy array
...
//        navigationView.setNavigationItemSelectedListener(this);
        ...
        AppController.getInstance().addToRequestQueue(BhavCopyReq);

        drawer = (DrawerLayout) findViewById(R.id.drawer_layout5);
        ...
        ExpAdapter=new ExpandListAdapter(BhavCopy_Details.this,ExpListItems);
        ...
        mDrawerList.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                ...
                if(groupPosition==1)
                {
                    if(childPosition==0)
                    {
                        Intent intent=new Intent(BhavCopy_Details.this,MostActiveContractsValue_Details.class);
                        startActivity(intent);
                    }
                    if(childPosition==1)
                    {
                        Intent intent=new Intent(BhavCopy_Details.this,MostActivityVolume_Details.class);
                        startActivity(intent);
                    }
                ...
                if(groupPosition==2)
                {
                    if(childPosition==0)
                    {
                        Intent intent=new Intent(BhavCopy_Details.this,TopGainers.class);
                        startActivity(intent);
                    }
                    if(childPosition==1)
                    {
                        Intent intent=new Intent(BhavCopy_Details.this,Top_Losers.class);
                        startActivity(intent);
                    }
                }
        ...
        mDrawerList.setOnGroupClickListener(new ExpandableListView.OnGroupClickListener() {
            ...
            public boolean onGroupClick(ExpandableListView parent, View v, int groupPosition, long id) {
                ...
                if(groupPosition==0)
                {
                    Intent intent=new Intent(BhavCopy_Details.this,MainActivity.class);
                    startActivity(intent);

                }
                if(groupPosition==3)
                {
                    Intent intent=new Intent(BhavCopy_Details.this,GraphActivity.class);
                    startActivity(intent);
                }
                if(groupPosition==4)
                {
                    Intent intent=new Intent(BhavCopy_Details.this,BhavCopy_Details.class);
                    startActivity(intent);
                }
                if(groupPosition==5)
                {
                    Intent intent=new Intent(BhavCopy_Details.this,Scriptdet_Details.class);
                    startActivity(intent);
                }
                if(groupPosition==6)
                {
                    Intent intent=new Intent(BhavCopy_Details.this,AboutUs.class);
                    startActivity(intent);
                }
                if(groupPosition==7)
                {
                    Intent intent=new Intent(BhavCopy_Details.this,ContactUs.class);
                    startActivity(intent);
                }
...
//
//                    Intent intent = new Intent(BhavCopy_Details.this, Scriptmas_Details.class);
//                    startActivity(intent);
//
