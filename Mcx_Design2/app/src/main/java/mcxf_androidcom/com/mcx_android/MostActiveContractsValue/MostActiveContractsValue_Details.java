...
public class MostActiveContractsValue_Details extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    // Log tag
    private static final String TAG = MostActiveContractsValue_Details.class.getSimpleName();
    private JSONArray result;
    TextView myTv;

    // MarketWatch json url
    private static final String url = "http://192.168.0.112:8888/MostActiveContractsValue.php";
    private ProgressDialog pDialog;
    private List<MostActiveContractsValue> ContractValuelist = new ArrayList<MostActiveContractsValue>();
    private ListView listView;
    private MostActiveContractsAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_most_active_contracts_value__details);

         toolbar = (Toolbar) findViewById(R.id.toolbar);
//        TextView textView= (TextView) toolbar.findViewById(R.id.macvalue1);
        if(toolbar!=null) {
...
//        View rootView = inflater.inflate(R.layout.activity_bhav_copy_details,container,false);


        listView = (ListView) findViewById(R.id.list);
//        ViewGroup headerView = (ViewGroup)getLayoutInflater().inflate(R.layout.header_controlvalues, listView,false);
//        listView.addHeaderView(headerView);
        adapter = new MostActiveContractsAdapter(this,ContractValuelist);
        ...
        JsonArrayRequest MostActiveReq = new JsonArrayRequest(url,
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        for (int i = 0; i < response.length(); i++) {
                            try {
                                ...
                                MostActiveContractsValue contractsValue = new MostActiveContractsValue();

                                contractsValue.setProduct(obj.getString("Product"));
                                contractsValue.setExpiry(obj.getString("Expiry"));
                                contractsValue.setValue(obj.getString("Value"));
                                contractsValue.setLTP(obj.getString("LTP"));
                                contractsValue.setPQU(obj.getString("PQU"));
                                contractsValue.setQL(obj.getString("QL"));

                                // adding MarketWatch to marketwatch array
                                ContractValuelist.add(contractsValue);
...
//        navigationView.setNavigationItemSelectedListener(this);
        ...
        AppController.getInstance().addToRequestQueue(MostActiveReq);
        ...
        ExpAdapter=new ExpandListAdapter(MostActiveContractsValue_Details.this,ExpListItems);
        ...
        mDrawerList.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                ...
                if(groupPosition==1)
                {
                    if(childPosition==0)
                    {
                        Intent intent=new Intent(MostActiveContractsValue_Details.this,MostActiveContractsValue_Details.class);
                        startActivity(intent);
                    }
                    if(childPosition==1)
                    {
                        Intent intent=new Intent(MostActiveContractsValue_Details.this,MostActivityVolume_Details.class);
                        startActivity(intent);
                    }
                ...
                if(groupPosition==2)
                {
                    if(childPosition==0)
                    {
                        Intent intent=new Intent(MostActiveContractsValue_Details.this,TopGainers.class);
                        startActivity(intent);
                    }
                    if(childPosition==1)
                    {
                        Intent intent=new Intent(MostActiveContractsValue_Details.this,Top_Losers.class);
                        startActivity(intent);
                    }
                }
        ...
        mDrawerList.setOnGroupClickListener(new ExpandableListView.OnGroupClickListener() {
            ...
            public boolean onGroupClick(ExpandableListView parent, View v, int groupPosition, long id) {
                ...
                if(groupPosition==0)
                {
                    Intent intent=new Intent(MostActiveContractsValue_Details.this,MainActivity.class);
                    startActivity(intent);

                }
                if(groupPosition==3)
                {
                    Intent intent=new Intent(MostActiveContractsValue_Details.this,GraphActivity.class);
                    startActivity(intent);
                }
                if(groupPosition==4)
                {
                    Intent intent=new Intent(MostActiveContractsValue_Details.this,BhavCopy_Details.class);
                    startActivity(intent);
                }
                if(groupPosition==5)
                {
                    Intent intent=new Intent(MostActiveContractsValue_Details.this,Scriptdet_Details.class);
                    startActivity(intent);
                }
                if(groupPosition==6)
                {
                    Intent intent=new Intent(MostActiveContractsValue_Details.this,AboutUs.class);
                    startActivity(intent);
                }
                if(groupPosition==7)
                {
                    Intent intent=new Intent(MostActiveContractsValue_Details.this,ContactUs.class);
                    startActivity(intent);
                }
...
//                }
                ...
                else if (item.getId() == R.id.imgLogo1) {
