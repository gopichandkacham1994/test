...
public class TopGainers extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    // Log tag
    private static final String TAG = TopGainers.class.getSimpleName();
    private JSONArray result;

    // TopGainers json url
    private static final String url = "http://192.168.0.112:8888/TopGains.php";
    private ProgressDialog pDialog;
    private List<TopGainlist> TopGainlist = new ArrayList<TopGainlist>();
    private ListView listView;
    private TopGains_ListAdapter adapter;
    //String Prodcut = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_topgainers);

         toolbar = (Toolbar) findViewById(R.id.toolbar);
        TextView textView= (TextView) toolbar.findViewById(R.id.topgain);
        if(toolbar!=null) {
...
//        ViewGroup headerView = (ViewGroup)getLayoutInflater().inflate(R.layout.header_topgains, listView,false);
//        listView.addHeaderView(headerView);
        adapter = new TopGains_ListAdapter(this, TopGainlist);
        ...
        JsonArrayRequest TopGainersReq = new JsonArrayRequest(url,
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        for (int i = 0; i < response.length(); i++) {
                            try {
                                ...
                                TopGainlist Top_gainers = new TopGainlist();

                                Top_gainers.setProduct(obj.getString("Product"));
                                Top_gainers.setExpiry(obj.getString("Expiry"));
                                Top_gainers.setPCP(String.format("%.2f", obj.getDouble("PCP")));
                                Top_gainers.setLTP(obj.getString("LTP"));
                                Top_gainers.setPercentageChange(obj.getString("PercentageChange"));
                                Top_gainers.setChange(obj.getString("PercentageChange"));

                                // adding MarketWatch to marketWatch_gainers array
                                TopGainlist.add(Top_gainers);
...
//        navigationView.setNavigationItemSelectedListener(this);
        ...
        AppController.getInstance().addToRequestQueue(TopGainersReq);
        ...
        ExpAdapter=new ExpandListAdapter(TopGainers.this,ExpListItems);
        ...
        mDrawerList.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                ...
                if(groupPosition==1)
                {
                    if(childPosition==0)
                    {
                        Intent intent=new Intent(TopGainers.this,MostActiveContractsValue_Details.class);
                        startActivity(intent);
                    }
                    if(childPosition==1)
                    {
                        Intent intent=new Intent(TopGainers.this,MostActivityVolume_Details.class);
                        startActivity(intent);
                    }
                ...
                if(groupPosition==2)
                {
                    if(childPosition==0)
                    {
                        Intent intent=new Intent(TopGainers.this,TopGainers.class);
                        startActivity(intent);
                    }
                    if(childPosition==1)
                    {
                        Intent intent=new Intent(TopGainers.this,Top_Losers.class);
                        startActivity(intent);
                    }
                }
        ...
        mDrawerList.setOnGroupClickListener(new ExpandableListView.OnGroupClickListener() {
            ...
            public boolean onGroupClick(ExpandableListView parent, View v, int groupPosition, long id) {
                ...
                if(groupPosition==0)
                {
                    Intent intent=new Intent(TopGainers.this,MainActivity.class);
                    startActivity(intent);

                }
                if(groupPosition==3)
                {
                    Intent intent=new Intent(TopGainers.this,GraphActivity.class);
                    startActivity(intent);
                }
                if(groupPosition==4)
                {
                    Intent intent=new Intent(TopGainers.this,BhavCopy_Details.class);
                    startActivity(intent);
                }
                if(groupPosition==5)
                {
                    Intent intent=new Intent(TopGainers.this,Scriptdet_Details.class);
                    startActivity(intent);
                }
                if(groupPosition==6)
                {
                    Intent intent=new Intent(TopGainers.this,AboutUs.class);
                    startActivity(intent);
                }
                if(groupPosition==7)
                {
                    Intent intent=new Intent(TopGainers.this,ContactUs.class);
                    startActivity(intent);
                }
...
//        DrawerLayout layout = (DrawerLayout)findViewById(R.id.drawer_layout3);
