...
//import mcxf_androidcom.com.mcx_android.MostActiveContractVolume.MostActiveVolume;
...
//
//
//public class LinechartActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
//
//    Spinner spinner;
...
//    private static final String url = "http://10.0.2.2/graph.php";
...
//    private String[] Time;
//
//    String[] spinneritems = {"Gold","Silver"};
//
//    @Override
...
//        spinner.setAdapter(new MyCustomerAdapter(LinechartActivity.this,R.layout.spinner_item,spinneritems));
...
//                if(position==1){
//                    Intent intent = new Intent(LinechartActivity.this,LineChart1.class);
...
//        leftAxis.setAxisMaxValue(31500f);
...
//        addData();
//
//        DrawerLayout drawer = (DrawerLayout) findViewById(R.id.drawer_layout10);
...
//                            Drawable drawable = ContextCompat.getDrawable(LinechartActivity.this, R.color.Graph);
...
//                Intent intent = new Intent(LinechartActivity.this, MostActiveContractsValue_Details.class);
//                startActivity(intent);
//            } else {
//                if (item.getId() == R.id.macvolume) {
//                    Intent intent = new Intent(LinechartActivity.this, MostActivityVolume_Details.class);
//                    startActivity(intent);
//                } else if (item.getId() == R.id.topgain) {
//                    Intent intent = new Intent(LinechartActivity.this, TopGainers.class);
//                    startActivity(intent);
//                } else if (item.getId() == R.id.toplose) {
//
//                    Intent intent = new Intent(LinechartActivity.this, Top_Losers.class);
//                    startActivity(intent);
//
//                } else if (item.getId() == R.id.Graphs) {
//
//                    Intent intent = new Intent(LinechartActivity.this, LinechartActivity.class);
//                    startActivity(intent);
//
//                } else if (item.getId() == R.id.BhavCopy) {
//
//                    Intent intent = new Intent(LinechartActivity.this, BhavCopy_Details.class);
//                    startActivity(intent);
//
//                } else if (item.getId() == R.id.scriptdet) {
//
//                    Intent intent = new Intent(LinechartActivity.this, Scriptdet_Details.class);
//                    startActivity(intent);
//
//                } else if (item.getId() == R.id.aboutUs) {
//
//                    Intent intent = new Intent(LinechartActivity.this, AboutUs.class);
//                    startActivity(intent);
//
//                } else if (item.getId() == R.id.Contactus) {
//
//                    Intent intent = new Intent(LinechartActivity.this, ContactUs.class);
//                    startActivity(intent);
//                }
