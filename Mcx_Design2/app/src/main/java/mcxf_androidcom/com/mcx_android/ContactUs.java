...
public class ContactUs extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView text= (TextView) toolbar.findViewById(R.id.ContactUs);
        if(toolbar!=null) {
            setSupportActionBar(toolbar);
            toolbar.setNavigationIcon(R.drawable.ic_ab_drawer);
        }

         drawer = (DrawerLayout) findViewById(R.id.drawer_layout9);
        ...
        ExpAdapter=new ExpandListAdapter(ContactUs.this,ExpListItems);
        ...
        mDrawerList.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                ...
                if(groupPosition==1)
                {
                    if(childPosition==0)
                    {
                        Intent intent=new Intent(ContactUs.this,MostActiveContractsValue_Details.class);
                        startActivity(intent);
                    }
                    if(childPosition==1)
                    {
                        Intent intent=new Intent(ContactUs.this,MostActivityVolume_Details.class);
                        startActivity(intent);
                    }
                ...
                if(groupPosition==2)
                {
                    if(childPosition==0)
                    {
                        Intent intent=new Intent(ContactUs.this,TopGainers.class);
                        startActivity(intent);
                    }
                    if(childPosition==1)
                    {
                        Intent intent=new Intent(ContactUs.this,Top_Losers.class);
                        startActivity(intent);
                    }
                }
        ...
        mDrawerList.setOnGroupClickListener(new ExpandableListView.OnGroupClickListener() {
            ...
            public boolean onGroupClick(ExpandableListView parent, View v, int groupPosition, long id) {
                ...
                if(groupPosition==3)
                {
                    Intent intent=new Intent(ContactUs.this,GraphActivity.class);
                    startActivity(intent);
                }
                if(groupPosition==4)
                {
                    Intent intent=new Intent(ContactUs.this,BhavCopy_Details.class);
                    startActivity(intent);
                }
                if(groupPosition==5)
                {
                    Intent intent=new Intent(ContactUs.this,Scriptdet_Details.class);
                    startActivity(intent);
                }
                if(groupPosition==6)
                {
