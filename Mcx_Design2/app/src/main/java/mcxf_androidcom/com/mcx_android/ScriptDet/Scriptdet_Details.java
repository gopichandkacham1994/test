...
public class Scriptdet_Details extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    // Log tag
    private static final String TAG = Scriptdet_Details.class.getSimpleName();
    private JSONArray result;

    // scriptdet json url
    private static final String url = "http://192.168.0.112:8888/scriptdetnew.php";
    private ProgressDialog pDialog;
    private List<Scriptdet> Scriptdetlist = new ArrayList<Scriptdet>();
    private ListView listView;
    private ListView listView1;
    private Scriptdet_ListAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scriptdet__details);
         toolbar = (Toolbar) findViewById(R.id.toolbar);
        TextView textView= (TextView) toolbar.findViewById(R.id.scriptdet);
        if(toolbar!=null) {
...
//        ViewGroup headerView = (ViewGroup)getLayoutInflater().inflate(R.layout.header_scriptdet, listView,false);
//        listView.addHeaderView(headerView);
        adapter = new Scriptdet_ListAdapter(this, Scriptdetlist);
        ...
        JsonArrayRequest ScriptdetReq = new JsonArrayRequest(url,
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        for (int i = 0; i < response.length(); i++) {
                            try {
                               ...
                               Scriptdet scriptdet = new Scriptdet();

                                scriptdet.setProduct(obj.getString("Product"));
                                scriptdet.setExpiry(obj.getString("Expiry"));
                                scriptdet.setTick_Size(obj.getString("Tick_Size"));
                                scriptdet.setTrading_Unit(obj.getString("Trading_Unit"));
                                scriptdet.setDelivery_Unit(obj.getString("Delivery_Unit"));
//                                scriptdet.setOPEN(String.format("%.2f", obj.getDouble("OPEN")));
//                                scriptdet.setHigh(String.format("%.2f", obj.getDouble("High")));
//                                scriptdet.setLow(String.format("%.2f", obj.getDouble("Low")));
//                                scriptdet.setClose(String.format("%.2f", obj.getDouble("Close")));
//                                scriptdet.setValue(obj.getString("Value"));
//                                scriptdet.setChangeInOI(obj.getString("ChangeInOI"));
//                                scriptdet.setPercentageChange(obj.getString("PercentageChange"));

                                // adding Scriptdet to scriptdet array
                                Scriptdetlist.add(scriptdet);
        ...
        AppController.getInstance().addToRequestQueue(ScriptdetReq);

        drawer = (DrawerLayout) findViewById(R.id.drawer_layout6);
        ...
        ExpAdapter=new ExpandListAdapter(Scriptdet_Details.this,ExpListItems);
        ...
        mDrawerList.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                ...
                if(groupPosition==1)
                {
                    if(childPosition==0)
                    {
                        Intent intent=new Intent(Scriptdet_Details.this,MostActiveContractsValue_Details.class);
                        startActivity(intent);
                    }
                    if(childPosition==1)
                    {
                        Intent intent=new Intent(Scriptdet_Details.this,MostActivityVolume_Details.class);
                        startActivity(intent);
                    }
                ...
                if(groupPosition==2)
                {
                    if(childPosition==0)
                    {
                        Intent intent=new Intent(Scriptdet_Details.this,TopGainers.class);
                        startActivity(intent);
                    }
                    if(childPosition==1)
                    {
                        Intent intent=new Intent(Scriptdet_Details.this,Top_Losers.class);
                        startActivity(intent);
                    }
                }
        ...
        mDrawerList.setOnGroupClickListener(new ExpandableListView.OnGroupClickListener() {
            ...
            public boolean onGroupClick(ExpandableListView parent, View v, int groupPosition, long id) {
                ...
                if(groupPosition==0)
                {
                    Intent intent=new Intent(Scriptdet_Details.this,MainActivity.class);
                    startActivity(intent);

                }
                if(groupPosition==3)
                {
                    Intent intent=new Intent(Scriptdet_Details.this,GraphActivity.class);
                    startActivity(intent);
                }
                if(groupPosition==4)
                {
                    Intent intent=new Intent(Scriptdet_Details.this,BhavCopy_Details.class);
                    startActivity(intent);
                }
                if(groupPosition==5)
                {
                    Intent intent=new Intent(Scriptdet_Details.this,Scriptdet_Details.class);
                    startActivity(intent);
                }
                if(groupPosition==6)
                {
                    Intent intent=new Intent(Scriptdet_Details.this,AboutUs.class);
                    startActivity(intent);
                }
                if(groupPosition==7)
                {
                    Intent intent=new Intent(Scriptdet_Details.this,ContactUs.class);
                    startActivity(intent);
                }
