...
public class Top_Losers extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    // Log tag
    private static final String TAG = Top_Losers.class.getSimpleName();
    private JSONArray result;

    // Top_Losers json url
    private static final String url = "http://192.168.0.112:8888/TopLoss.php";
    private ProgressDialog pDialog;
    private List<TopLosers_list> TopLossList = new ArrayList<TopLosers_list>();
    private ListView listView;
    private TopLosers_ListAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_top_losers);

        toolbar = (Toolbar) findViewById(R.id.toolbar);
        TextView textView= (TextView) toolbar.findViewById(R.id.toplose);
        if(toolbar!=null) {
...
//        ViewGroup headerView = (ViewGroup)getLayoutInflater().inflate(R.layout.header_toplose, listView,false);
//        listView.addHeaderView(headerView);
        adapter = new TopLosers_ListAdapter(this, TopLossList);
        ...
        JsonArrayRequest TopLosersReq = new JsonArrayRequest(url,
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        for (int i = 0; i < response.length(); i++) {
                            try {
                                ...
                                TopLosers_list TopLosers = new TopLosers_list();

                                TopLosers.setProduct(obj.getString("Product"));
                                TopLosers.setExpiry(obj.getString("Expiry"));
                                TopLosers.setPCP(String.format("%.2f", obj.getDouble("PCP")));
                                TopLosers.setLTP(obj.getString("LTP"));
                                TopLosers.setPercentageChange(obj.getString("PercentageChange"));
                                TopLosers.setChange(obj.getString("PercentageChange"));

                                // adding MarketWatch to marketWatch_TopLosers array
                                TopLossList.add(TopLosers);
...
//        navigationView.setNavigationItemSelectedListener(this);
        ...
        AppController.getInstance().addToRequestQueue(TopLosersReq);
        ...
        ExpAdapter=new ExpandListAdapter(Top_Losers.this,ExpListItems);
        ...
        mDrawerList.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                ...
                if(groupPosition==1)
                {
                    if(childPosition==0)
                    {
                        Intent intent=new Intent(Top_Losers.this,MostActiveContractsValue_Details.class);
                        startActivity(intent);
                    }
                    if(childPosition==1)
                    {
                        Intent intent=new Intent(Top_Losers.this,MostActivityVolume_Details.class);
                        startActivity(intent);
                    }
                ...
                if(groupPosition==2)
                {
                    if(childPosition==0)
                    {
                        Intent intent=new Intent(Top_Losers.this,TopGainers.class);
                        startActivity(intent);
                    }
                    if(childPosition==1)
                    {
                        Intent intent=new Intent(Top_Losers.this,Top_Losers.class);
                        startActivity(intent);
                    }
                }
        ...
        mDrawerList.setOnGroupClickListener(new ExpandableListView.OnGroupClickListener() {
            ...
            public boolean onGroupClick(ExpandableListView parent, View v, int groupPosition, long id) {
                ...
                if(groupPosition==0)
                {
                    Intent intent=new Intent(Top_Losers.this,MainActivity.class);
                    startActivity(intent);

                }
                if(groupPosition==3)
                {
                    Intent intent=new Intent(Top_Losers.this,GraphActivity.class);
                    startActivity(intent);
                }
                if(groupPosition==4)
                {
                    Intent intent=new Intent(Top_Losers.this,BhavCopy_Details.class);
                    startActivity(intent);
                }
                if(groupPosition==5)
                {
                    Intent intent=new Intent(Top_Losers.this,Scriptdet_Details.class);
                    startActivity(intent);
                }
                if(groupPosition==6)
                {
                    Intent intent=new Intent(Top_Losers.this,AboutUs.class);
                    startActivity(intent);
                }
                if(groupPosition==7)
                {
                    Intent intent=new Intent(Top_Losers.this,ContactUs.class);
                    startActivity(intent);
                }
