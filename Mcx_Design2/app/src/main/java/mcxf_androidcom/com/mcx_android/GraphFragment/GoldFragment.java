...
public class GoldFragment extends Fragment {
    ...
    private static final String url = "http://192.168.0.112:8888/graph.php";
    private static final String url1 ="http://192.168.0.112:8888/graphhighest.php";
    private float[] ltp1;
   ...
   private int preval=0;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        listView= (ListView) v.findViewById(R.id.list_frag_gold);
        adapter1=new Table_Adapter(getActivity(),TableGraphlist);
        listView.setAdapter(adapter1);

        mChart= (LineChart) v.findViewById(R.id.frag_gold_linechart);
...
//        mChart.setBorderColor(Color.rgb(0,102,163));
...
//        leftAxis.setValueFormatter(custom);
        ...
        leftAxis.setAxisMinValue(29500f);
